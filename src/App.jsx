...
export default function RetirementCalculator() {
  ...
  return (
    <div style={{ padding: "20px 8px 40px", maxWidth: 600, margin: "0 auto", fontFamily: "-apple-system, 'Apple SD Gothic Neo', sans-serif", background: "#ffffff", color: "#111111", minHeight: "100vh" }}>
